...
class ParrainCodeGeneratorService:
    ...
    @staticmethod
    def verify_code(db: Session, num_parrain: str, code: str, expiration_minutes: int = 30) -> bool:
        """
        Vérifie si le code fourni est valide pour un parrain donné.
        Un code est valide s'il correspond et n'a pas expiré (par défaut 30 minutes).
        ...
        return latest_code.code == code and now <= expiration_time
