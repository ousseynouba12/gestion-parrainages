          ...
          children: <Widget>[
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => ParrainageScreen()),
                );
              },
              style: ElevatedButton.styleFrom(
                backgroundColor: Color(0xFF0A0E21),
...
class ParrainageScreen extends StatelessWidget {
  ...
  final List<Map<String, String>> candidats = [
    {'nom': 'Bintou', 'parti': 'Parti A'},
    {'nom': 'Aminata', 'parti': 'Parti B'},
    {'nom': 'Fatoumata', 'parti': 'Parti C'},
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Parrainer un candidat'),
        backgroundColor: Color(0xFF1D1E33),
      ),
      body: Padding(
        padding: const EdgeInsets.all(16.0),
                    ...
                    ElevatedButton(
                      onPressed: () {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(
                            content: Text(
                              'Vous avez parrainé ${candidat['nom']} !',
                              style: TextStyle(color: Colors.white),
                            ),
